...
const isEgging = ref(false);
const isHidden = ref(false);

const handleButtonCLick = () => {
  if (isEgging.value) {
    isEgging.value = false;
    isHidden.value = true;
    return;
  }
  ...
  <div class="py-3 sm:py-0">
    ...
    <div class="flex justify-center" v-if="!isHidden">
      <button
        ...
        :class="[!isEgging ? 'animate-bounce' : '']"
      >
        <!-- <Twemoji emoji="🥚" height="20px" width="20px" /> -->
        <span v-if="!isEgging" class="flex justify-center items-center gap-2">
        ...
        <span v-else class="flex justify-center items-center gap-2">
          <span class="h-7 w-7 inline-block"
            ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36">
              <path
                fill="#FFCB4C"
                d="M35 17c0 9.389-7.611 17-17 17S1 26.389 1 17 8.611 0 18 0s17 7.611 17 17"
              />
              <ellipse
                fill="#65471B"
                cx="17.812"
